...
class VirtualMachine extends EventEmitter {
    ...
    saveProjectSb3() {
        ...
        var rtNull = genCharList(charList, 32);
        var rtLarge = genCharList(charList, 32);
        var rtDot = genCharList(charList, 32);

        console.log("Generated costume uid for $rt.null: " + rtNull);
        console.log("Generated costume uid for $rt.large: " + rtLarge);
        console.log("Generated costume uid for $rt.dot: " + rtDot);

        zip.file(rtLarge + ".svg", largeCostumeSvg);
        zip.file(rtNull + ".svg", nullCostumeSvg);
        zip.file(rtDot + ".svg", dotCosumeSvg);

        zip.file('project.json', toSb3(projectJson, {
            rt_null: rtNull,
            rt_large: rtLarge,
            rt_dot: rtDot
        }));
     ...
     */
    toJSON(optTargetId) {
        const sb3 = require('./serialization/sbpp');
